  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          "origin-top-center relative mt-2.5 h-(--radix-navigation-menu-viewport-height) w-full overflow-hidden rounded-[22px] bg-popover text-popover-foreground shadow-xl ring-1 ring-black/5 duration-100 md:w-(--radix-navigation-menu-viewport-width) data-open:animate-in data-open:zoom-in-90 data-closed:animate-out data-closed:zoom-out-90",
          className
        )}
        {...props}
      />
