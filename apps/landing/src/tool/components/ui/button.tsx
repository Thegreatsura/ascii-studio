  ...
  "inline-flex cursor-pointer items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        landing:
          "bg-[#FFFFFF] shadow-[0px_4px_1px_rgba(0,0,0,0.01),0px_2px_1px_rgba(0,0,0,0.05),0px_1px_1px_rgba(0,0,0,0.09),0px_0px_1px_rgba(0,0,0,0.1),inset_0px_2px_2.2px_#FFFFFF] rounded-[99px]",
        landingBlue:
          "bg-[#79A4FF] shadow-[0px_0px_4px_rgba(0,0,0,0.04),0px_8px_16px_rgba(0,0,0,0.08),inset_2px_3px_3.5px_rgba(255,255,255,0.25)] rounded-[77px] text-white",
      },
      size: {
