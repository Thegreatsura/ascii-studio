...
export function buildASCIIAnimationReactComponentSource({
  ...
  return [
    ...
    `					.ascii-effect-video { background-image: url('${appearance.gifUrl}'); background-size: cover; background-clip: text; -webkit-background-clip: text; color: transparent !important; }`,
